...
A policy tells us which action to take at state $S_t$. It can be either deterministic $\pi (s) = a$, or stochastic $\pi (a\|s) = \mathbb{P}_{\pi} [A = a \| S = s]$. The future reward, a.k.a return, is the sum of discounted upcoming rewards:
...
$$V_{\pi} (s) = \mathbb{E}_{\pi} [G_t \| S_t = s] = \sum_{a \in \mathcal{A}} Q_{\pi} (s, a) \pi (a\|s) = \mathbb{E}_{a \sim \pi (\cdot \| s)} [Q_{\pi} (s, a)].$$
...
$$P^a_{ss'} = \mathbb{P} [S_{t+1} = s' \| S_t = s, A_t = a] = \sum_{r \in \mathcal{R}} \mathbb{P} [S_{t+1} = s', R_{t+1} = r\| S_t = s, A_t = a],$$

and all states are assumed to be Markov: $\mathbb{P} [S_{t+1} \| S_t] = \mathbb{P} [S_{t+1} \| S_1, \ldots, S_t]$.
...
$$Q_{\pi} (s, a) = \mathbb{E}_{\pi} [R_{t+1} + \gamma \mathbb{E}_{a' \sim \pi (\cdot \| S_{t+1})} [Q_{\pi} (S_{t+1}, a')] \| S_t = s, A_t = a].$$

### Expectation Equation
State-value:

$$V_{\pi} (s) = \sum_{a \in \mathcal{A}} \pi (a\|s) Q_{\pi} (s, a) = \sum_{a \in \mathcal{A}} \pi (a\|s) \bigg(R(s, a) + \gamma \sum_{s' \in \mathcal{S}} P^a_{ss'} V_{\pi} (s')\bigg).$$

Action-value:

$$Q_{\pi} (s, a) = R(s,a) + \gamma \sum_{s' \in \mathcal{S}} P^a_{ss'} V_{\pi} (s') = R(s,a) + \gamma \sum_{s' \in \mathcal{S}} P^a_{ss'} \sum_{a' \in \mathcal{A}} \pi (a' \| s') Q_{\pi} (s', a').$$
...
$$V_{\pi} (s) = \sum_{a \in \mathcal{A}} \pi (a\|s) \bigg(R(s, a) + \gamma \sum_{s' \in \mathcal{S}} P^a_{ss'} V_{\pi} (s')\bigg).$$

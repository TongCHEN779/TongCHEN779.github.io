...
$$J (\theta) = \mathbb{E}_{S_0 \sim \bar{\pi}_{\theta}} [V_{\pi_{\theta}} (S_0)] = \mathbb{E}_{S_0 \sim \bar{\pi}_{\theta}} \big[\mathbb{E}_{A_0 \sim \pi_{\theta} (\cdot \vert S_0)} [Q_{\pi_{\theta}} (S_0, A_0)]\big],$$
